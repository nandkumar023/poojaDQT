...
public class UserDropDownPage extends BasePage {
	...
	public UserDropDownPage(WebDriver driver) {
		super(driver);
		this.driver= driver;
	...
	@Override
	public UserDropDownPage waitForPage() throws InterruptedException {
	...
	public void verifyViewProfileUsermenuIsVisible(final String viewProfileText) throws InterruptedException {
	...
	public void verifyMyVaultUsermenuIsVisible(final String myVaultText) throws InterruptedException {
	...
	public void verifyCalendarUsermenuIsVisible(final String calendarText) throws InterruptedException {
	...
	public void verifyBookmarksUsermenuIsVisible(final String bookmarksText) throws InterruptedException {
	...
	public void verifySettingsUsermenuIsVisible(final String settingsText) throws InterruptedException {
	...
	public void verifySendFeedbackUsermenuIsVisible(final String sendFeedbackText) throws InterruptedException {
	...
	public void verifyTermsConditionsUsermenuIsVisible(final String termsConditionsText) throws InterruptedException {
	...
	public void verifylogoutUsermenuIsVisible(final String logoutText) throws InterruptedException {
