...
public class GrandRoundTest extends BaseTest {
	...
	public void verifyOptionsUnderDiscussion(final String number, final String otp, final String country) throws InterruptedException {
//		driver.get(PostURL);
	...
	@Test(dataProvider = "loginTest", dataProviderClass = DataProviders.class, groups = { "SmokeTest" },enabled = false)
	public void verifyOptionsUnderLearning(final String number, final String otp, final String country) throws InterruptedException {
		driver.get(PostURL);
		loginPage = new LoginPage(driver).waitForPage();
		GRPage = loginPage.loginWithMobileAndCountry(number, otp, country);
		GRPage.waitForPage();
	...
	@Test(dataProvider = "loginTest", dataProviderClass = DataProviders.class, groups = { "SmokeTest" },enabled = false)
	public void verifyOptionsUnderDocquityExclusive(final String number, final String otp, final String country) throws InterruptedException {
		driver.get(PostURL);
		loginPage = new LoginPage(driver).waitForPage();
		GRPage = loginPage.loginWithMobileAndCountry(number, otp, country);
		GRPage.waitForPage();
	...
	@Test(dataProvider = "loginTest", dataProviderClass = DataProviders.class, groups = { "SmokeTest" },enabled = false)
	public void clickStartAPost(final String number, final String otp, final String country)
	...
	// groups= {"SmokeTest"})
	public void verifyTheUIElementsOfGRScreen(final String number, final String otp, final String country) throws InterruptedException {
		driver.get(PostURL);
		loginPage = new LoginPage(driver).waitForPage();
		GRPage = loginPage.loginWithMobileAndCountry(number, otp, country);
		GRPage.waitForPage();
...
//		GRPage = loginPage.loginWithMobileAndCountry(number, otp, country);
//		GRPage.waitForPage();
//		GRPage.clickOnUserDropdown();
//		GRPage.verifyViewProfileUsermenuIsVisible("View Profile");
//		GRPage.verifyMyVaultUsermenuIsVisible("My Vault");
//		GRPage.verifyCalendarUsermenuIsVisible("Calendar");
//		GRPage.verifyBookmarksUsermenuIsVisible("Bookmarks");
//		GRPage.verifySettingsUsermenuIsVisible("Settings");
//		GRPage.verifySendFeedbackUsermenuIsVisible("Send Feedback");
//		GRPage.verifyTermsConditionsUsermenuIsVisible("Terms & Conditions");
//		GRPage.verifylogoutUsermenuIsVisible("Logout");
//	}
